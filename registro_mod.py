...
def normalizar_dni(valor) -> str:
    """
    Formato general del DNI: solo dígitos, siempre en 8 posiciones (zfill).
    Misma lógica que formulario.py, para que un DNI se reconozca igual en
    Alta, Bajas y Edición.
    """
    import re
